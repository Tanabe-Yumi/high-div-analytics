 ...
 * Total max score: 40
 */
export function calculateScore(metrics: EvaluationMetrics): Score {
    const score: Score = {
        sales: scoreSales(metrics.sales),
        operatingProfitMargin: scoreOperatingProfitMargin(metrics.operatingProfitMargin),
...
function scoreSales(value: number): number {
...
function scoreOperatingProfitMargin(value: number): number {
...
function scoreEPS(value: number): number {
...
function scoreEquityRatio(value: number): number {
...
function scoreOperatingCashFlow(value: number): number {
...
function scoreDividendPerShare(value: number): number {
...
function scorePayoutRatio(value: number): number {
